    ...
    internal static class PeWriter
    {
                    ...
                    CancellationToken cancellationToken)
        {
            try
            {
                ...
                var
                peBuilder = f_506_10362_10918(peHeaderBuilder, metadataRootBuilder, ilBuilder, 
                mappedFieldDataBuilder, managedResourceBuilder, 
                f_506_10584_10637(context.Module), debugDirectoryBuilder, 
                f_506_10696_10759(context.Module, privateKeyOpt), entryPointHandle, corFlags, peIdProvider, 
                metadataOnly && (DynAbs.Tracing.TraceSender.Expression_True(506, 10871, 10917) && 
                f_506_10887_10917_M(!context.IncludePrivateMembers)))
                ;
