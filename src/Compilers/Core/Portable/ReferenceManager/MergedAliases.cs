    ...
    internal sealed class MergedAliases
    {
        ...
        private static void AddNonIncluded(ArrayBuilder<string> builder, ImmutableArray<string> items)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(533, 3522, 3723);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(533, 1, 202);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(533, 1, 202);
                }
