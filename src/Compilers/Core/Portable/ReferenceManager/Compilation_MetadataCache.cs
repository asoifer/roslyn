    ...
    public partial class Compilation
    {
        ...
        internal void AddRetargetingAssemblySymbolsNoLock<T>(List<T> result) where T : IAssemblySymbolInternal
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(532, 2569, 2690);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(532, 1, 122);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(532, 1, 122);
                }
