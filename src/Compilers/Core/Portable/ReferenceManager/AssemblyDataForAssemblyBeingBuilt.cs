...
namespace Microsoft.CodeAnalysis
{
    internal partial class CommonReferenceManager<TCompilation, TAssemblySymbol>
    {
        protected sealed class AssemblyDataForAssemblyBeingBuilt : AssemblyData
        {
                            ...
                            ImmutableArray<PEModule> modules)
            {
                try
                {
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(525, 1633, 1770);
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(525, 1, 138);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(525, 1, 138);
                    }
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(525, 1852, 1857);
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(525, 1843, 1995))
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(525, 1, 153);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(525, 1, 153);
                    }
                            ...
                            AssemblyIdentityComparer assemblyIdentityComparer)
            {
                try
                {
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(525, 3072, 3077);
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(525, 3063, 3363))
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(525, 1, 301);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(525, 1, 301);
                    }
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(525, 3631, 3665);
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(525, 3622, 3999))
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(525, 1, 378);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(525, 1, 378);
                    }
