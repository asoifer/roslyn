    ...
    internal sealed class DeltaMetadataWriter : MetadataWriter
    {
        ...
        internal EmitBaseline GetDelta(EmitBaseline baseline, Compilation compilation, Guid encId, MetadataSizes metadataSizes)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 8522, 8725);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 204);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 204);
                }
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 8975, 8980);
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(758, 8966, 9116))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 151);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 151);
                }
        ...
        private static IReadOnlyDictionary<K, V> AddRange<K, V>(IReadOnlyDictionary<K, V> previous, IReadOnlyDictionary<K, V> current, bool replace = false, IEqualityComparer<K> comparer = null)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 12556, 12667);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 112);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 112);
                }
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 12683, 12865);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 183);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 183);
                }
        ...
        public void GetMethodTokens(ICollection<MethodDefinitionHandle> methods)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 13126, 13550);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 425);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 425);
                }
        ...
        protected override void CreateIndicesForNonTypeMembers(ITypeDefinition typeDef)
        {
            try
            {
                ...
                switch (change)
                {
                    ...
                    case SymbolChange.Added:
...

                        {
                            ...
                            try
                            {
                                DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 22061, 22228);
                            ...
                            {
                                DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 168);
                                throw;
                            }
                            finally
                            {
                                DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 168);
                            }
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 22904, 23252);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 349);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 349);
                }
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 23268, 23418);
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 23434, 24224);
                    foreach (var methodDef in f_758_23460_23492_I(f_758_23460_23492(typeDef, this.Context)))
                    {
...

                        {
                            ...
                            try
                            {
                                DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 23618, 23874);
                            ...
                            {
                                DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 257);
                                throw;
                            }
                            finally
                            {
                                DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 257);
                            }
...

                            {
                                ...
                                try
                                {
                                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 23987, 24167);
                                ...
                                {
                                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 181);
                                    throw;
                                }
                                finally
                                {
                                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 181);
                                }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 791);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 791);
                }
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 24240, 24613);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 374);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 374);
                }
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 24790, 25684);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 895);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 895);
                }
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 25782, 26314);
                    foreach (var methodDefIndex in f_758_25813_25832_I(implementingMethods))
                    {
                        ...
                        {
                            DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 25898, 26299);
                            throw;
                        }
                        finally
                        {
                            DynAbs.Tracing.TraceSender.TraceExitLoop(758, 25898, 26299);
                        }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 533);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 533);
                }
        ...
        protected override void ReportReferencesToAddedSymbols()
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 27411, 27556);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 146);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 146);
                }
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 27572, 27723);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 152);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 152);
                }
        ...
        protected override StandaloneSignatureHandle SerializeLocalVariablesSignature(IMethodBody body)
        {
            try
            {
...

                {
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 28801, 29451);
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 651);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 651);
                    }
                    ...
                    where T : class, ITypeDefinitionMember
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 34429, 35214);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 786);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 786);
                }
                    ...
                    where T : class, ITypeDefinitionMember
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 35487, 36056);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 570);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 570);
                }
        ...
        private void PopulateEncLogTableParameters()
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 36220, 36225);
                    for (int
        i = 0
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(758, 36211, 36741))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 531);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 531);
                }
                    ...
                    where T : class, IDefinition
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 36919, 37171);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 253);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 253);
                }
        ...
        private void PopulateEncLogTableRows(TableIndex tableIndex, int firstRowId, int tokenCount)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 37594, 37599);
                    for (int
        i = 0
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(758, 37585, 37835))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 251);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 251);
                }
        ...
        protected override void PopulateEncMapTableRows(ImmutableArray<int> rowCounts)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 41127, 41235);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 109);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 109);
                }
...

                {
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 41865, 41999);
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 135);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 135);
                    }
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 43939, 43944);
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(758, 43930, 44183))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 254);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 254);
                }
        ...
        private static void AddReferencedTokens(ArrayBuilder<EntityHandle> builder, TableIndex tableIndex, int firstRowId, int nTokens)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 44747, 44752);
                    for (int
        i = 0
        ...
        , i++, DynAbs.Tracing.TraceSender.TraceExitCondition(758, 44738, 44882))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 145);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 145);
                }
                    ...
                    where T : class, IDefinition
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 45098, 45246);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 149);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 149);
                }
        ...
        protected override void PopulateEventMapTableRows()
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 45345, 45628);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 284);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 284);
                }
        ...
        protected override void PopulatePropertyMapTableRows()
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 45730, 46028);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 299);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 299);
                }
        ...
        private abstract class DefinitionIndexBase<T>
        {
            ...
            public IReadOnlyDictionary<T, int> GetAdded()
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 47358, 47501);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 47436, 47450);

                    f_758_47436_47449(this);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 47468, 47486);

                    return this.added;
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 47358, 47501);

                    int
                    f_758_47436_47449(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndexBase<T>
                    this_param)
                    {
                        this_param.Freeze();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 47436, 47449);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 47358, 47501);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 47358, 47501);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            public IReadOnlyList<T> GetRows()
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 47593, 47723);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 47659, 47673);

                    f_758_47659_47672(this);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 47691, 47708);

                    return this.rows;
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 47593, 47723);

                    int
                    f_758_47659_47672(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndexBase<T>
                    this_param)
                    {
                        this_param.Freeze();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 47659, 47672);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 47593, 47723);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 47593, 47723);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            protected virtual void OnFrozen()
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 48088, 48466);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48213, 48226);
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48244, 48443);
                        foreach (var row in f_758_48264_48273_I(this.rows))
                        {
                            DynAbs.Tracing.TraceSender.TraceEnterCondition(758, 48244, 48443);
                            DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48315, 48342);

                            int
                            next = f_758_48326_48341(this.added, row)
                            ;
                            DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48364, 48390);

                            f_758_48364_48389(prev < next);
                            DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48412, 48424);

                            prev = next;
                            DynAbs.Tracing.TraceSender.TraceExitCondition(758, 48244, 48443);
                        }
                    }
                    catch (System.Exception)
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(758, 1, 200);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(758, 1, 200);
                    }
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 48088, 48466);

                    int
                    f_758_48326_48341(System.Collections.Generic.Dictionary<T, int>
                    this_param, T
                    i0)
                    {
                        var return_v = this_param[i0];
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 48326, 48341);
                        return return_v;
                    }


                    int
                    f_758_48364_48389(bool
                    condition)
                    {
                        Debug.Assert(condition);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 48364, 48389);
                        return 0;
                    }


                    System.Collections.Generic.List<T>
                    f_758_48264_48273_I(System.Collections.Generic.List<T>
                    i)
                    {
                        var return_v = i;
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 48264, 48273);
                        return return_v;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 48088, 48466);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 48088, 48466);
                }
            }
            ...
            private void Freeze()
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 48482, 48677);

                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48536, 48662) || true) && (!_frozen)
                    )

                    {
                        DynAbs.Tracing.TraceSender.TraceEnterCondition(758, 48536, 48662);
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48590, 48605);

                        _frozen = true;
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 48627, 48643);

                        f_758_48627_48642(this);
                        DynAbs.Tracing.TraceSender.TraceExitCondition(758, 48536, 48662);
                    }
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 48482, 48677);

                    int
                    f_758_48627_48642(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndexBase<T>
                    this_param)
                    {
                        this_param.OnFrozen();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 48627, 48642);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 48482, 48677);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 48482, 48677);
                }
            }
        ...
        private sealed class DefinitionIndex<T> : DefinitionIndexBase<T> where T : class, IDefinition
        {
            ...
            public override bool TryGetValue(T item, out int index)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 49637, 50218);

                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 49725, 49841) || true) && (f_758_49729_49768(this.added, item, out index))
                    )

                    {
                        DynAbs.Tracing.TraceSender.TraceEnterCondition(758, 49725, 49841);
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 49810, 49822);

                        return true;
                        DynAbs.Tracing.TraceSender.TraceExitCondition(758, 49725, 49841);
                    }

                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 49861, 50172) || true) && (f_758_49865_49902(this, item, out index))
                    )

                    {
                        DynAbs.Tracing.TraceSender.TraceEnterCondition(758, 49861, 50172);
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 49955, 49963);

                        T
                        other
                        = default(T);
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 49985, 50070);

                        f_758_49985_50069(!f_758_49999_50033(_map, index, out other) || (DynAbs.Tracing.TraceSender.Expression_False(758, 49998, 50068) || ((object)other == (object)item)));
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50100, 50119);

                        _map[index] = item;
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50141, 50153);

                        return true;
                        DynAbs.Tracing.TraceSender.TraceExitCondition(758, 49861, 50172);
                    }
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50190, 50203);

                    return false;
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 49637, 50218);

                    bool
                    f_758_49729_49768(System.Collections.Generic.Dictionary<T, int>
                    this_param, T
                    key, out int
                    value)
                    {
                        var return_v = this_param.TryGetValue(key, out value);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 49729, 49768);
                        return return_v;
                    }


                    bool
                    f_758_49865_49902(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndex<T>
                    this_param, T
                    item, out int
                    index)
                    {
                        var return_v = this_param._tryGetExistingIndex(item, out index);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 49865, 49902);
                        return return_v;
                    }


                    bool
                    f_758_49999_50033(System.Collections.Generic.Dictionary<int, T>
                    this_param, int
                    key, out T
                    value)
                    {
                        var return_v = this_param.TryGetValue(key, out value);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 49999, 50033);
                        return return_v;
                    }


                    int
                    f_758_49985_50069(bool
                    condition)
                    {
                        Debug.Assert(condition);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 49985, 50069);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 49637, 50218);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 49637, 50218);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            public void Add(T item)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 50404, 50672);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50460, 50489);

                    f_758_50460_50488(f_758_50473_50487_M(!this.IsFrozen));
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50509, 50536);

                    int
                    index = f_758_50521_50535(this)
                    ;
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50554, 50582);

                    f_758_50554_50581(this.added, item, index);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50600, 50619);

                    _map[index] = item;
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50637, 50657);

                    f_758_50637_50656(this.rows, item);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 50404, 50672);

                    bool
                    f_758_50473_50487_M(bool
                    i)
                    {
                        var return_v = i;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 50473, 50487);
                        return return_v;
                    }


                    int
                    f_758_50460_50488(bool
                    condition)
                    {
                        Debug.Assert(condition);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 50460, 50488);
                        return 0;
                    }


                    int
                    f_758_50521_50535(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndex<T>
                    this_param)
                    {
                        var return_v = this_param.NextRowId;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 50521, 50535);
                        return return_v;
                    }


                    int
                    f_758_50554_50581(System.Collections.Generic.Dictionary<T, int>
                    this_param, T
                    key, int
                    value)
                    {
                        this_param.Add(key, value);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 50554, 50581);
                        return 0;
                    }


                    int
                    f_758_50637_50656(System.Collections.Generic.List<T>
                    this_param, T
                    item)
                    {
                        this_param.Add(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 50637, 50656);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 50404, 50672);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 50404, 50672);
                }
            }
            ...
            public void AddUpdated(T item)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 50858, 51003);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50921, 50950);

                    f_758_50921_50949(f_758_50934_50948_M(!this.IsFrozen));
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 50968, 50988);

                    f_758_50968_50987(this.rows, item);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 50858, 51003);

                    bool
                    f_758_50934_50948_M(bool
                    i)
                    {
                        var return_v = i;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 50934, 50948);
                        return return_v;
                    }


                    int
                    f_758_50921_50949(bool
                    condition)
                    {
                        Debug.Assert(condition);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 50921, 50949);
                        return 0;
                    }


                    int
                    f_758_50968_50987(System.Collections.Generic.List<T>
                    this_param, T
                    item)
                    {
                        this_param.Add(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 50968, 50987);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 50858, 51003);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 50858, 51003);
                }
            }
            ...
            public bool IsAddedNotChanged(T item)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 51019, 51140);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 51089, 51125);

                    return f_758_51096_51124(this.added, item);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 51019, 51140);

                    bool
                    f_758_51096_51124(System.Collections.Generic.Dictionary<T, int>
                    this_param, T
                    key)
                    {
                        var return_v = this_param.ContainsKey(key);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 51096, 51124);
                        return return_v;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 51019, 51140);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 51019, 51140);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            protected override void OnFrozen()
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(758, 51156, 51271);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(758, 51223, 51256);

                    f_758_51223_51255(this.rows, this.CompareRows);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 51156, 51271);

                    int
                    f_758_51223_51255(System.Collections.Generic.List<T>
                    this_param, System.Comparison<T>
                    comparison)
                    {
                        this_param.Sort(comparison);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(758, 51223, 51255);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(758, 51156, 51271);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(758, 51156, 51271);
                }
            }
            ...
            private int CompareRows(T x, T y)
            {
                try
                {
                    ...
                    return f_758_51360_51367(this, x) - f_758_51370_51377(this, y);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(758, 51287, 51393);

                    int
                    f_758_51360_51367(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndex<T>
                    this_param, T
                    i0)
                    {
                        var return_v = this_param[i0];
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 51360, 51367);
                        return return_v;
                    }


                    int
                    f_758_51370_51377(Microsoft.CodeAnalysis.Emit.DeltaMetadataWriter.DefinitionIndex<T>
                    this_param, T
                    i0)
                    {
                        var return_v = this_param[i0];
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(758, 51370, 51377);
                        return return_v;
                    }
