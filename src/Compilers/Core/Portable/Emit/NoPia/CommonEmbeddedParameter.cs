            ...
            TEmbeddedTypeParameter>
    {
        internal abstract class CommonEmbeddedParameter : Cci.IParameterDefinition
        {
            ...
            private bool IsTargetAttribute(TAttributeData attrData, AttributeDescription description)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(774, 2845, 3063);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 2967, 3048);

                    return f_774_2974_3047(f_774_2974_2985(), UnderlyingParameter, attrData, description);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(774, 2845, 3063);

                    TEmbeddedTypesManager
                    f_774_2974_2985()
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 2974, 2985);
                        return return_v;
                    }


                    bool
                    f_774_2974_3047(TEmbeddedTypesManager
                    ...
                    description)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 2974, 3047);
                        return return_v;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(774, 2845, 3063);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(774, 2845, 3063);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            private ImmutableArray<TAttributeData> GetAttributes(TPEModuleBuilder moduleBuilder, TSyntaxNode syntaxNodeOpt, DiagnosticBag diagnostics)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(774, 3079, 6339);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 3250, 3307);

                    var
                    builder = f_774_3264_3306()
                    ;
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 3653, 6268);
                        foreach (var attrData in f_774_3678_3718_I(f_774_3678_3718(this, moduleBuilder)))
                        {
                            DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 3653, 6268);

                            if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 3760, 6249) || true) && (f_774_3764_3833(this, attrData, AttributeDescription.ParamArrayAttribute))
                            )

                            {
                                DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 3760, 6249);

                                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 3883, 4167) || true) && (attrData.CommonConstructorArguments.Length == 0)
                                )

                                {
                                    DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 3883, 4167);
                                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 3992, 4140);

                                    f_774_3992_4139(builder, f_774_4012_4138(f_774_4012_4023(), WellKnownMember.System_ParamArrayAttribute__ctor, attrData, syntaxNodeOpt, diagnostics));
                                    DynAbs.Tracing.TraceSender.TraceExitCondition(774, 3883, 4167);
                                }
                                DynAbs.Tracing.TraceSender.TraceExitCondition(774, 3760, 6249);
                            }
                            ...
                            else
                            {
                                ...
                                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 4217, 6249) || true) && (f_774_4221_4296(this, attrData, AttributeDescription.DateTimeConstantAttribute))
                                )

                                {
                                    DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 4217, 6249);

                                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 4346, 4661) || true) && (attrData.CommonConstructorArguments.Length == 1)
                                    )

                                    {
                                        DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 4346, 4661);
                                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 4455, 4634);

                                        f_774_4455_4633(builder, f_774_4475_4632(f_774_4475_4486(), WellKnownMember.System_Runtime_CompilerServices_DateTimeConstantAttribute__ctor, attrData, syntaxNodeOpt, diagnostics));
                                        DynAbs.Tracing.TraceSender.TraceExitCondition(774, 4346, 4661);
                                    }
                                    DynAbs.Tracing.TraceSender.TraceExitCondition(774, 4217, 6249);
                                }
                                ...
                                {
                                    DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 4217, 6249);
                                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 4759, 4903);

                                    int
                                    signatureIndex = f_774_4780_4902(f_774_4780_4791(), UnderlyingParameter, attrData, AttributeDescription.DecimalConstantAttribute)
                                    ;

                                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 4929, 6226) || true) && (signatureIndex != -1)
                                    )

                                    {
                                        DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 4929, 6226);
                                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5011, 5068);

                                        f_774_5011_5067(signatureIndex == 0 || (DynAbs.Tracing.TraceSender.Expression_False(774, 5024, 5066) || signatureIndex == 1));

                                        if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5100, 5668) || true) && (attrData.CommonConstructorArguments.Length == 5)
                                        )

                                        {
                                            DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 5100, 5668);
                                            DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5217, 5637);

                                            f_774_5217_5636(builder, f_774_5237_5635(f_774_5237_5248(), (DynAbs.Tracing.TraceSender.Conditional_F1(774, 5314, 5333) || ((signatureIndex == 0 && DynAbs.Tracing.TraceSender.Conditional_F2(774, 5336, 5414)) || DynAbs.Tracing.TraceSender.Conditional_F3(774, 5458, 5559))) ? WellKnownMember.System_Runtime_CompilerServices_DecimalConstantAttribute__ctor : WellKnownMember.System_Runtime_CompilerServices_DecimalConstantAttribute__ctorByteByteInt32Int32Int32, attrData, syntaxNodeOpt, diagnostics));
                                            DynAbs.Tracing.TraceSender.TraceExitCondition(774, 5100, 5668);
                                        }
                                        DynAbs.Tracing.TraceSender.TraceExitCondition(774, 4929, 6226);
                                    }
                                    ...
                                    else
                                    {
                                        ...
                                        if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5726, 6226) || true) && (f_774_5730_5810(this, attrData, AttributeDescription.DefaultParameterValueAttribute))
                                        )

                                        {
                                            DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 5726, 6226);

                                            if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5868, 6199) || true) && (attrData.CommonConstructorArguments.Length == 1)
                                            )

                                            {
                                                DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 5868, 6199);
                                                DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 5985, 6168);

                                                f_774_5985_6167(builder, f_774_6005_6166(f_774_6005_6016(), WellKnownMember.System_Runtime_InteropServices_DefaultParameterValueAttribute__ctor, attrData, syntaxNodeOpt, diagnostics));
                                                DynAbs.Tracing.TraceSender.TraceExitCondition(774, 5868, 6199);
                                            }
                                            DynAbs.Tracing.TraceSender.TraceExitCondition(774, 5726, 6226);
                                        }
                                        DynAbs.Tracing.TraceSender.TraceExitCondition(774, 4929, 6226);
                                    }
                                    DynAbs.Tracing.TraceSender.TraceExitCondition(774, 4217, 6249);
                            ...
                            DynAbs.Tracing.TraceSender.TraceExitCondition(774, 3653, 6268);
                        }
                    }
                    catch (System.Exception)
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(774, 1, 2616);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(774, 1, 2616);
                    }
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 6288, 6324);

                    return f_774_6295_6323(builder);
                    DynAbs.Tracing.TraceSender.TraceExitMethod(774, 3079, 6339);

                    Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    f_774_3264_3306()
                    {
                        var return_v = ArrayBuilder<TAttributeData>.GetInstance();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 3264, 3306);
                        return return_v;
                    }


                    System.Collections.Generic.IEnumerable<TAttributeData>
                    f_774_3678_3718(Microsoft.CodeAnalysis.Emit.NoPia.EmbeddedTypesManager<TPEModuleBuilder, TModuleCompilationState, TEmbeddedTypesManager, TSyntaxNode, TAttributeData, TSymbol, TAssemblySymbol, TNamedTypeSymbol, TFieldSymbol, TMethodSymbol, TEventSymbol, TPropertySymbol, TParameterSymbol, TTypeParameterSymbol, TEmbeddedType, TEmbeddedField, TEmbeddedMethod, TEmbeddedEvent, TEmbeddedProperty, TEmbeddedParameter, TEmbeddedTypeParameter>.CommonEmbeddedParameter
                    this_param, TPEModuleBuilder
                    moduleBuilder)
                    {
                        var return_v = this_param.GetCustomAttributesToEmit(moduleBuilder);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 3678, 3718);
                        return return_v;
                    }
                    ...
                    description)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 3764, 3833);
                        return return_v;
                    }
                    ...
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 4012, 4023);
                        return return_v;
                    }


                    TAttributeData
                    f_774_4012_4138(TEmbeddedTypesManager
                    ...
                    diagnostics)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 4012, 4138);
                        return return_v;
                    }


                    int
                    f_774_3992_4139(Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    builder, TAttributeData
                    item)
                    {
                        builder.AddOptional<TAttributeData>(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 3992, 4139);
                        return 0;
                    }


                    bool
                    f_774_4221_4296(Microsoft.CodeAnalysis.Emit.NoPia.EmbeddedTypesManager<TPEModuleBuilder, TModuleCompilationState, TEmbeddedTypesManager, TSyntaxNode, TAttributeData, TSymbol, TAssemblySymbol, TNamedTypeSymbol, TFieldSymbol, TMethodSymbol, TEventSymbol, TPropertySymbol, TParameterSymbol, TTypeParameterSymbol, TEmbeddedType, TEmbeddedField, TEmbeddedMethod, TEmbeddedEvent, TEmbeddedProperty, TEmbeddedParameter, TEmbeddedTypeParameter>.CommonEmbeddedParameter
                    this_param, TAttributeData
                    attrData, Microsoft.CodeAnalysis.AttributeDescription
                    description)
                    {
                        var return_v = this_param.IsTargetAttribute(attrData, description);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 4221, 4296);
                        return return_v;
                    }
                    ...
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 4475, 4486);
                        return return_v;
                    }


                    TAttributeData
                    f_774_4475_4632(TEmbeddedTypesManager
                    this_param, Microsoft.CodeAnalysis.WellKnownMember
                    constructor, TAttributeData
                    attrData, TSyntaxNode
                    syntaxNodeOpt, Microsoft.CodeAnalysis.DiagnosticBag
                    ...
                    {
                        var return_v = this_param.CreateSynthesizedAttribute(constructor, attrData, syntaxNodeOpt, diagnostics);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 4475, 4632);
                        return return_v;
                    }


                    int
                    f_774_4455_4633(Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    builder, TAttributeData
                    item)
                    {
                        builder.AddOptional<TAttributeData>(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 4455, 4633);
                        return 0;
                    }
                    ...
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 4780, 4791);
                        return return_v;
                    }


                    int
                    f_774_4780_4902(TEmbeddedTypesManager
                    this_param, TParameterSymbol
                    underlyingSymbol, TAttributeData
                    attrData, Microsoft.CodeAnalysis.AttributeDescription
                    description)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 4780, 4902);
                        return return_v;
                    }


                    int
                    f_774_5011_5067(bool
                    condition)
                    {
                        Debug.Assert(condition);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 5011, 5067);
                        return 0;
                    }
                    ...
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 5237, 5248);
                        return return_v;
                    }


                    TAttributeData
                    f_774_5237_5635(TEmbeddedTypesManager
                    this_param, Microsoft.CodeAnalysis.WellKnownMember
                    constructor, TAttributeData
                    attrData, TSyntaxNode
                    syntaxNodeOpt, Microsoft.CodeAnalysis.DiagnosticBag
                    ...
                    {
                        var return_v = this_param.CreateSynthesizedAttribute(constructor, attrData, syntaxNodeOpt, diagnostics);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 5237, 5635);
                        return return_v;
                    }


                    int
                    f_774_5217_5636(Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    builder, TAttributeData
                    item)
                    {
                        builder.AddOptional<TAttributeData>(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 5217, 5636);
                        return 0;
                    }


                    bool
                    f_774_5730_5810(Microsoft.CodeAnalysis.Emit.NoPia.EmbeddedTypesManager<TPEModuleBuilder, TModuleCompilationState, TEmbeddedTypesManager, TSyntaxNode, TAttributeData, TSymbol, TAssemblySymbol, TNamedTypeSymbol, TFieldSymbol, TMethodSymbol, TEventSymbol, TPropertySymbol, TParameterSymbol, TTypeParameterSymbol, TEmbeddedType, TEmbeddedField, TEmbeddedMethod, TEmbeddedEvent, TEmbeddedProperty, TEmbeddedParameter, TEmbeddedTypeParameter>.CommonEmbeddedParameter
                    this_param, TAttributeData
                    attrData, Microsoft.CodeAnalysis.AttributeDescription
                    description)
                    {
                        var return_v = this_param.IsTargetAttribute(attrData, description);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 5730, 5810);
                        return return_v;
                    }
                    ...
                    {
                        var return_v = TypeManager;
                        DynAbs.Tracing.TraceSender.TraceEndMemberAccess(774, 6005, 6016);
                        return return_v;
                    }


                    TAttributeData
                    f_774_6005_6166(TEmbeddedTypesManager
                    this_param, Microsoft.CodeAnalysis.WellKnownMember
                    constructor, TAttributeData
                    attrData, TSyntaxNode
                    syntaxNodeOpt, Microsoft.CodeAnalysis.DiagnosticBag
                    ...
                    {
                        var return_v = this_param.CreateSynthesizedAttribute(constructor, attrData, syntaxNodeOpt, diagnostics);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 6005, 6166);
                        return return_v;
                    }


                    int
                    f_774_5985_6167(Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    builder, TAttributeData
                    item)
                    {
                        builder.AddOptional<TAttributeData>(item);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 5985, 6167);
                        return 0;
                    }


                    System.Collections.Generic.IEnumerable<TAttributeData>
                    f_774_3678_3718_I(System.Collections.Generic.IEnumerable<TAttributeData>
                    i)
                    {
                        var return_v = i;
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 3678, 3718);
                    ...
                    f_774_6295_6323(Microsoft.CodeAnalysis.PooledObjects.ArrayBuilder<TAttributeData>
                    this_param)
                    {
                        var return_v = this_param.ToImmutableAndFree();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 6295, 6323);
                        return return_v;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(774, 3079, 6339);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(774, 3079, 6339);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
            ...
            IEnumerable<Cci.ICustomAttribute> Cci.IReference.GetAttributes(EmitContext context)
            {
                try
                {
                    DynAbs.Tracing.TraceSender.TraceEnterMethod(774, 7921, 8698);

                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8037, 8640) || true) && (_lazyAttributes.IsDefault)
                    )

                    {
                        DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 8037, 8640);
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8108, 8154);

                        var
                        diagnostics = f_774_8126_8153()
                        ;
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8176, 8290);

                        var
                        attributes = f_774_8193_8289(this, context.Module, context.SyntaxNodeOpt, diagnostics)
                        ;

                        if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8314, 8578) || true) && (f_774_8318_8393(ref _lazyAttributes, attributes))
                        )

                        {
                            DynAbs.Tracing.TraceSender.TraceEnterCondition(774, 8314, 8578);
                            DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8513, 8555);

                            f_774_8513_8554(                        // Save any diagnostics that we encountered.
                                                    context.Diagnostics, diagnostics);
                            DynAbs.Tracing.TraceSender.TraceExitCondition(774, 8314, 8578);
                        }
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8602, 8621);

                        f_774_8602_8620(
                                            diagnostics);
                        DynAbs.Tracing.TraceSender.TraceExitCondition(774, 8037, 8640);
                    }
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(774, 8660, 8683);

                    return _lazyAttributes;
                    DynAbs.Tracing.TraceSender.TraceExitMethod(774, 7921, 8698);

                    Microsoft.CodeAnalysis.DiagnosticBag
                    f_774_8126_8153()
                    {
                        var return_v = DiagnosticBag.GetInstance();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 8126, 8153);
                        return return_v;
                    }


                    System.Collections.Immutable.ImmutableArray<TAttributeData>
                    f_774_8193_8289(Microsoft.CodeAnalysis.Emit.NoPia.EmbeddedTypesManager<TPEModuleBuilder, TModuleCompilationState, TEmbeddedTypesManager, TSyntaxNode, TAttributeData, TSymbol, TAssemblySymbol, TNamedTypeSymbol, TFieldSymbol, TMethodSymbol, TEventSymbol, TPropertySymbol, TParameterSymbol, TTypeParameterSymbol, TEmbeddedType, TEmbeddedField, TEmbeddedMethod, TEmbeddedEvent, TEmbeddedProperty, TEmbeddedParameter, TEmbeddedTypeParameter>.CommonEmbeddedParameter
                    ...
                    diagnostics)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 8193, 8289);
                        return return_v;
                    }


                    bool
                    f_774_8318_8393(ref System.Collections.Immutable.ImmutableArray<TAttributeData>
                    ...
                    value)
                    {
                        ...
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 8318, 8393);
                        return return_v;
                    }


                    int
                    f_774_8513_8554(Microsoft.CodeAnalysis.DiagnosticBag
                    this_param, Microsoft.CodeAnalysis.DiagnosticBag
                    bag)
                    {
                        this_param.AddRange(bag);
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 8513, 8554);
                        return 0;
                    }


                    int
                    f_774_8602_8620(Microsoft.CodeAnalysis.DiagnosticBag
                    this_param)
                    {
                        this_param.Free();
                        DynAbs.Tracing.TraceSender.TraceEndInvocation(774, 8602, 8620);
                        return 0;
                    }
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(774, 7921, 8698);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(774, 7921, 8698);
                }
                throw new System.Exception("Slicer error: unreachable code");
            }
