...
namespace Microsoft.CodeAnalysis
{
    internal class CommonAssemblyWellKnownAttributeData<TNamedTypeSymbol> : WellKnownAttributeData, ISecurityAttributeTarget
    {
        ...
        SecurityWellKnownAttributeData ISecurityAttributeTarget.GetOrCreateData()
        {
            try
            {
                DynAbs.Tracing.TraceSender.TraceEnterMethod(786, 12684, 13076);
                DynAbs.Tracing.TraceSender.TraceSimpleStatement(786, 12782, 12812);

                f_786_12782_12811(this, expected: false);

                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(786, 12828, 13015) || true) && (_lazySecurityAttributeData == null)
                )

                {
                    DynAbs.Tracing.TraceSender.TraceEnterCondition(786, 12828, 13015);
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(786, 12900, 12966);

                    _lazySecurityAttributeData = f_786_12929_12965();
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(786, 12984, 13000);

                    f_786_12984_12999(this);
                    DynAbs.Tracing.TraceSender.TraceExitCondition(786, 12828, 13015);
                }
                DynAbs.Tracing.TraceSender.TraceSimpleStatement(786, 13031, 13065);

                return _lazySecurityAttributeData;
                DynAbs.Tracing.TraceSender.TraceExitMethod(786, 12684, 13076);

                int
                f_786_12782_12811(Microsoft.CodeAnalysis.CommonAssemblyWellKnownAttributeData<TNamedTypeSymbol>
                this_param, bool
                expected)
                {
                    this_param.VerifySealed(expected: expected);
                    DynAbs.Tracing.TraceSender.TraceEndInvocation(786, 12782, 12811);
                    return 0;
                }
                ...
                f_786_12929_12965()
                {
                    ...
                    DynAbs.Tracing.TraceSender.TraceEndInvocation(786, 12929, 12965);
                    return return_v;
                }


                int
                f_786_12984_12999(Microsoft.CodeAnalysis.CommonAssemblyWellKnownAttributeData<TNamedTypeSymbol>
                this_param)
                {
                    this_param.SetDataStored();
                    DynAbs.Tracing.TraceSender.TraceEndInvocation(786, 12984, 12999);
                    return 0;
                }
            ...
            {
                DynAbs.Tracing.TraceSender.TraceEnterFinalCatch(786, 12684, 13076);
                throw;
            }
            finally
            {
                DynAbs.Tracing.TraceSender.TraceEnterFinalFinally(786, 12684, 13076);
            }
            throw new System.Exception("Slicer error: unreachable code");
        }
