    ...
    internal static class ParameterHelpers
    {
                    ...
                    bool addRefReadOnlyModifier)
        {
            try
            {
                ...
                SeparatedSyntaxList<ParameterSyntax> f_10235_1340_1357(BaseParameterListSyntax baseParameterListSyntax)
                {
                    var return_v = baseParameterListSyntax.Parameters;
                    DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10235, 1340, 1357);
                    return return_v;
                }

                return f_10235_951_2401(binder, owner, f_10235_1075_1092(syntax), 
                    out arglistToken, diagnostics, allowRefOrOut, allowThis, 
                    addRefReadOnlyModifier, suppressUseSiteDiagnostics: false, 
                    lastIndex: f_10235_1340_1357(syntax).Count - 1, 
                    ...
                    where TOwningSymbol : Symbol
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 6316, 9412);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 3097);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 3097);
                }
                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 9428, 9827) || true) && (mustBeLastParameter != null && 
                    (DynAbs.Tracing.TraceSender.Expression_True(10235, 9432, 9511) && 
                    mustBeLastParameter != f_10235_9486_9511(parametersList, lastIndex)))
                )
                {
                ...
                // LAFHIS
                TParameterSyntax
                f_10235_9486_9511(SeparatedSyntaxList<TParameterSyntax>
                this_param, int
                item)
                {
                    var return_v = this_param[item];
                    DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10235, 9486, 9511);
                    return return_v;
                }
        ...
        internal static void EnsureIsReadOnlyAttributeExists(CSharpCompilation compilation, ImmutableArray<ParameterSymbol> parameters, DiagnosticBag diagnostics, bool modifyCompilation)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 11261, 11551);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 291);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 291);
                }
        ...
        internal static void EnsureNativeIntegerAttributeExists(CSharpCompilation compilation, ImmutableArray<ParameterSymbol> parameters, DiagnosticBag diagnostics, bool modifyCompilation)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 12089, 12404);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 316);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 316);
                }
        ...
        internal static void EnsureNullableAttributeExists(CSharpCompilation compilation, Symbol container, ImmutableArray<ParameterSymbol> parameters, DiagnosticBag diagnostics, bool modifyCompilation)
        {
            try
            {
...

                {
                    ...
                    try
                    {
                        DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 13069, 13404);
                    ...
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 336);
                        throw;
                    }
                    finally
                    {
                        DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 336);
                    }
        ...
        private static void CheckParameterModifiers(BaseParameterSyntax parameter, DiagnosticBag diagnostics, bool parsingFunctionPointerParams)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 13907, 21180);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 7274);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 7274);
                }
        ...
        private static bool IsValidDefaultValue(BoundExpression expression)
        {
            try
            {
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 33570, 34064);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 33570, 34064);
                }
        ...
        internal static MethodSymbol FindContainingGenericMethod(Symbol symbol)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 34433, 34449);
                    for (Symbol
        current = symbol
        ...
        , current = f_10235_34486_34510(current), DynAbs.Tracing.TraceSender.TraceExitCondition(10235, 34421, 34895))
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 475);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 475);
                }
        ...
        private static RefKind GetModifiers(SyntaxTokenList modifiers, out SyntaxToken refnessKeyword, out SyntaxToken paramsKeyword, out SyntaxToken thisKeyword)
        {
            try
            {
                ...
                try
                {
                    DynAbs.Tracing.TraceSender.TraceSimpleStatement(10235, 35320, 36620);
                ...
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoopByException(10235, 1, 1301);
                    throw;
                }
                finally
                {
                    DynAbs.Tracing.TraceSender.TraceExitLoop(10235, 1, 1301);
                }
