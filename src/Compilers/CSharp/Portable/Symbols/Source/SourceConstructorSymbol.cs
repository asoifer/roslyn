    ...
    internal sealed class SourceConstructorSymbol : SourceConstructorSymbolBase
    {
                    ...
                    DiagnosticBag diagnostics)
        {
            try
            {
                ...
                var methodKind = (DynAbs.Tracing.TraceSender.Conditional_F1(10241, 882, 928) || ((f_10241_882_898(syntax).Any(SyntaxKind.StaticKeyword) 
                    && DynAbs.Tracing.TraceSender.Conditional_F2(10241, 931, 959)) || DynAbs.Tracing.TraceSender.Conditional_F3(10241, 962, 984))) ? 
                    MethodKind.StaticConstructor : MethodKind.Constructor;
                DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 999, 1143);

                return f_10241_1006_1142(containingType, f_10241_1050_1067(syntax).GetLocation(), syntax, methodKind, isNullableAnalysisEnabled, diagnostics);
        ...
        // LAFHIS
        static SyntaxTokenList f_10241_882_898(ConstructorDeclarationSyntax syntax)
        {
            var return_v = syntax.Modifiers;
            DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10241, 882, 898);
            return return_v;
        }

        static SyntaxToken f_10241_1050_1067(ConstructorDeclarationSyntax syntax)
        {
            var return_v = syntax.Identifier;
            DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10241, 1050, 1067);
            return return_v;
        }
                     ...
                     DiagnosticBag diagnostics) : base(f_10241_1489_1503_C(containingType), location, syntax, f_10241_1523_1561(syntax))
        {
            try
            {
                ...
                // LAFHIS
                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 2237, 2478) || true) && 
                    (f_10241_2241_2258(syntax).ValueText != f_10241_2272_2291(containingType))
                )
...

                {
                    ...
                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 2540, 2750) || true) && 
                        (methodKind == MethodKind.Constructor && 
                        (DynAbs.Tracing.TraceSender.Expression_True(10241, 2544, 2610) && 
                        f_10241_2584_2602(syntax) != null))
                    )
                ...
                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 2934, 3111) || true) && 
                ...
                var info = f_10241_3138_3245(this.DeclarationModifiers, this, isExplicitInterfaceImplementation: false);
        ...
        SyntaxToken f_10241_2241_2258(ConstructorDeclarationSyntax syntax)
        {
            var return_v = syntax.Identifier;
            DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10241, 2241, 2258);
            return return_v;
        }
        ...
        private DeclarationModifiers MakeModifiers(SyntaxTokenList modifiers, MethodKind methodKind, bool hasBody, Location location, DiagnosticBag diagnostics, out bool modifierErrors)
        {
            try
            {
                ...
                var defaultAccess = (DynAbs.Tracing.TraceSender.Conditional_F1(10241, 4361, 4405) || 
                    (((methodKind == MethodKind.StaticConstructor) && DynAbs.Tracing.TraceSender.Conditional_F2(10241, 4408, 4433)) || 
                    DynAbs.Tracing.TraceSender.Conditional_F3(10241, 4436, 4464))) ? DeclarationModifiers.None : DeclarationModifiers.Private;
        ...
        private void CheckModifiers(MethodKind methodKind, bool hasBody, Location location, DiagnosticBag diagnostics)
        {
            try
            {
                ...
                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 6145, 6744) || true) && (!hasBody && 
                    (DynAbs.Tracing.TraceSender.Expression_True(10241, 6149, 6170) && f_10241_6161_6170_M(!IsExtern)))
                )
                ...
                else
                {
                    ...
                    if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 6305, 6744) || true) && (f_10241_6309_6332(f_10241_6309_6323()) && 
                        (DynAbs.Tracing.TraceSender.Expression_True(10241, 6309, 6377) && f_10241_6336_6377(f_10241_6336_6362(this))) && 
                        (DynAbs.Tracing.TraceSender.Expression_True(10241, 6309, 6397) && f_10241_6381_6397_M(!this.IsOverride)))
                    )
                    ...
                    else
                    {
                        ...
                        if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 6562, 6744) || true) && (f_10241_6566_6589(f_10241_6566_6580()) && 
                            (DynAbs.Tracing.TraceSender.Expression_True(10241, 6566, 6629) && methodKind == MethodKind.Constructor))
                        )
        ...
        internal override bool IsNullableAnalysisEnabled()
        {
            try
            {
                ...
                return (DynAbs.Tracing.TraceSender.Conditional_F1(10241, 7239, 7258) || ((_hasThisInitializer && 
                    DynAbs.Tracing.TraceSender.Conditional_F2(10241, 7278, 7309)) || DynAbs.Tracing.TraceSender.Conditional_F3(10241, 7329, 7436))) ? 
        ...
        protected override bool IsWithinExpressionOrBlockBody(int position, out int offset)
        {
            try
            {
                ...
                ConstructorDeclarationSyntax ctorSyntax = f_10241_7758_7769(this);

                if ((DynAbs.Tracing.TraceSender.TraceSimpleStatement(10241, 7807, 8301) || true) && 
                    ((DynAbs.Tracing.TraceSender.Conditional_F1(10241, 7811, 7834) || ((f_10241_7811_7826(ctorSyntax) != null && 
                    DynAbs.Tracing.TraceSender.Conditional_F2(10241, 7837, 7884)) || DynAbs.Tracing.TraceSender.Conditional_F3(10241, 7887, 7892))) ? 
                    f_10241_7837_7852(ctorSyntax).Span.Contains(position) == true : false)
                )

                {
                    ...
                    // LAFHIS
                    offset = position - f_10241_7946_7966(f_10241_7946_7961(ctorSyntax)).Start;
                ...
                else
                {
...

                    {
                        ...
                        // LAFHIS
                        offset = position - f_10241_8219_8249(f_10241_8219_8244(ctorSyntax)).Start;
                ...
                // LAFHIS
                Microsoft.CodeAnalysis.Text.TextSpan f_10241_8219_8249(
                    Microsoft.CodeAnalysis.CSharp.Syntax.ArrowExpressionClauseSyntax arrowExpressionClauseSyntax)
                {
                    var return_v = arrowExpressionClauseSyntax.Span;
                    DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10241, 8219, 8249);
                    return return_v;
                }

                Microsoft.CodeAnalysis.Text.TextSpan f_10241_7946_7966(
                    Microsoft.CodeAnalysis.CSharp.Syntax.BlockSyntax blockSyntax)
                {
                    var return_v = blockSyntax.Span;
                    DynAbs.Tracing.TraceSender.TraceEndMemberAccess(10241, 7946, 7966);
                    return return_v;
                }
